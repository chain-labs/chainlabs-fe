...
export const fontSizes = {
	h1: { mobS: '3.2rem', tabS: '3.6rem', deskL: '7.2rem' },
	h2: { mobS: '2.4rem', tabS: '3.2rem', deskL: '4.8rem' },
	h3: { mobS: '2rem', tabS: '2.4rem', deskL: '3.6rem' },
	b1: { mobS: '1.6rem', tabS: '2rem', deskL: '2.4rem' },
	b2: { mobS: '1.6rem', tabS: '2rem', deskL: '2.4rem' },
	b3: { mobS: '1.2rem', tabS: '1.6rem', deskL: '2rem' },
	links: { mobS: '1.4rem', tabS: '1.6rem', deskL: '2rem' },
};
